package com.currency.exchange.currencyExchanger.dto.exchangerateapi;

import java.util.Map;

public class JsonBlockExchangeRateApi {
    ...
    public JsonBlockExchangeRateApi(String result, String terms_of_use,
    ...
    public JsonBlockExchangeRateApi() {
    }
